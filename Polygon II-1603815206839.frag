...
void main() {
    ...
    float radius = 0.6;
    float drift = 0.3;
    float rotation = 0.;//snoise( ij + vec2(0.0, u_time*0.03))*TWO_PI;
    float angle = snoise(ij +  vec2(100.0, u_time*0.03)) * 2.5 *TWO_PI;;
    
    vec2 v0 = vec2(0.5) + circlePoint(pointRotation(ij+vec2(0))+rotation, radius) + circleNoise( ij + vec2(0.) ) * drift; //0.2*cos( 0.40*u_time + vec2(0.0,2.00) + 0.0 );
	vec2 v1 = vec2(0.5) + circlePoint(pointRotation(ij+vec2(1))+rotation+TWO_PI/5., radius) + circleNoise( ij +vec2(2.) ) * drift; //+ 0.2*cos( 0.45*u_time + vec2(0.0,1.50) + 1.0 );
	vec2 v2 = vec2(0.5) + circlePoint(pointRotation(ij+vec2(2))+rotation+2.0*TWO_PI/5., radius) + circleNoise( ij +vec2(4.) ) * drift; //0.2*cos( 0.50*u_time + vec2(0.0,3.00) + 2.0 );
	vec2 v3 = vec2(0.5) + circlePoint(pointRotation(ij+vec2(3))+rotation+3.0*TWO_PI/5., radius) + circleNoise( ij +vec2(8.) ) * drift; //0.2*cos( 0.55*u_time + vec2(0.0,2.00) + 4.0 );
    vec2 v4 = vec2(0.5) + circlePoint(pointRotation(ij+vec2(4))+rotation+4.0*TWO_PI/5., radius) + circleNoise( ij +vec2(14.) ) * drift; //0.2*cos( 0.60*u_time + vec2(0.0,1.00) + 5.0 );
