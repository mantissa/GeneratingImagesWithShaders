...
void main() {
	...
	vec2 v1 = vec2(0.5) + circlePoint(rotation+TWO_PI/5., radius) + circleNoise( ij +vec2(1.) ) * drift; //+ 0.2*cos( 0.45*u_time + vec2(0.0,1.50) + 1.0 );
	vec2 v2 = vec2(0.5) + circlePoint(rotation+2.0*TWO_PI/5., radius) + circleNoise( ij +vec2(2.) ) * drift; //0.2*cos( 0.50*u_time + vec2(0.0,3.00) + 2.0 );
	vec2 v3 = vec2(0.5) + circlePoint(rotation+3.0*TWO_PI/5., radius) + circleNoise( ij +vec2(3.) ) * drift; //0.2*cos( 0.55*u_time + vec2(0.0,2.00) + 4.0 );
    vec2 v4 = vec2(0.5) + circlePoint(rotation+4.0*TWO_PI/5., radius) + circleNoise( ij +vec2(4.) ) * drift; //0.2*cos( 0.60*u_time + vec2(0.0,1.00) + 5.0 );
